<template>
  <v-container style="margin: 200px ;align-items: center; justify-content: center;">
    <h2 class="display-2" style="color: #ac2925">Reset Password</h2>
    <v-form @submit.prevent="handleEdit" v-model="valid">
      ...
      <v-btn color="red" lager style="float: left; margin: 20px " type="submit" :disabled="!valid">
        SAVE
      </v-btn>
    </v-form>
  </v-container>
