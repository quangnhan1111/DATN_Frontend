    ...
    <div class="table_responsive">
      <div class="header-table">
        <div class="header-table__item">
          <strong class="title"> List categories </strong>
          <input
              class="input-search"
              placeholder="Search..."
              v-model="searchValue"
        ...
        <div class="header-table__item">
          <template >
            <router-link to="/add-category"  tag="button" class="btn btn-dark">New Category</router-link>
          </template>
        </div>
      </div>
      <table>
        ...
        <tbody>
        <tr v-for="item in searchValue.length < 1 ? listCategory : searchResults" :key="item.id">
          <td>{{item.id}}</td>
          <td>{{item.name}}</td>
          ...
          <td>
            <span class="action_btn">
              ...
              <button class="btn" @click="deleteCategory(item.id)">Remove</button>
            </span>
